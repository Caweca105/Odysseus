...
// Use runtime config to get the Laravel REST API endpoint
const config = useRuntimeConfig();
const baseUrl = config.public.restLaravelEndpoint.replace(/\/+$/, "");

// Fetch users from the Laravel REST API
